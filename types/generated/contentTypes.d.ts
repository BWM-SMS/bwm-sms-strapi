...
export interface ApiClassAttendanceDetailClassAttendanceDetail extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    classAttendance: Schema.Attribute.Relation<'manyToOne', 'api::class-attendance.class-attendance'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    editedBy: Schema.Attribute.Relation<'oneToOne', 'plugin::users-permissions.user'> & Schema.Attribute.Private;
    isAttend: Schema.Attribute.Boolean & Schema.Attribute.Required & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::class-attendance-detail.class-attendance-detail'> &
      Schema.Attribute.Private;
    note: Schema.Attribute.Text;
    position: Schema.Attribute.Enumeration<
      ['A. \u73ED\u957F', 'B. \u526F\u73ED\u957F', 'C. \u5173\u6000\u5458', 'D. \u5B66\u5458', 'E. \u65C1\u542C']
    > &
      Schema.Attribute.Required &
    ...
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    username: Schema.Attribute.Relation<'manyToOne', 'plugin::users-permissions.user'>;
  };
}

export interface ApiClassAttendanceClassAttendance extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    classAttendanceDetails: Schema.Attribute.Relation<'oneToMany', 'api::class-attendance-detail.class-attendance-detail'>;
    ...
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::class-attendance.class-attendance'> & Schema.Attribute.Private;
    note: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiClassClass extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    classAttendances: Schema.Attribute.Relation<'oneToMany', 'api::class-attendance.class-attendance'>;
    classDay: Schema.Attribute.Enumeration<['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday']>;
    ...
    language: Schema.Attribute.Enumeration<['C. \u534E\u6587', 'B. \u53CC\u8BED', 'Y. \u5B66\u9752']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    room: Schema.Attribute.Enumeration<
      ['BWM-301', 'BWM-302', 'BWM-303', 'BWM-304', 'BWM-305', 'BWM-306', 'BWM-307', 'BWM-308', 'BWM-309', 'BWM-310', 'BWM-311', 'FC-1903']
    >;
    ...
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    userClasses: Schema.Attribute.Relation<'oneToMany', 'api::user-class.user-class'>;
...
export interface ApiConfigurationConfiguration extends Struct.SingleTypeSchema {
  ...
  attributes: {
    closeSubmitAttendance: Schema.Attribute.Integer & Schema.Attribute.Required & Schema.Attribute.DefaultTo<1440>;
    closeTakeAttendance: Schema.Attribute.Integer & Schema.Attribute.Required & Schema.Attribute.DefaultTo<30>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::configuration.configuration'> & Schema.Attribute.Private;
    openTakeAttendance: Schema.Attribute.Integer & Schema.Attribute.Required & Schema.Attribute.DefaultTo<60>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
...
export interface ApiEnrollmentEnrollment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    classDay: Schema.Attribute.Enumeration<['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday']> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    email: Schema.Attribute.String;
    englishName: Schema.Attribute.String & Schema.Attribute.Required;
    gender: Schema.Attribute.Enumeration<['Male', 'Female']> & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::enrollment.enrollment'> & Schema.Attribute.Private;
...
export interface ApiHolidayScheduleHolidaySchedule extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    date: Schema.Attribute.Date & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::holiday-schedule.holiday-schedule'> & Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    notes: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['Public Holiday', 'Monastery Holiday', 'Maintenance', 'Restricted Access']> &
      Schema.Attribute.Required &
...
export interface ApiNotificationServiceNotificationService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::notification-service.notification-service'> & Schema.Attribute.Private;
...
export interface ApiSusFeedbackSusFeedback extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    improvementModule: Schema.Attribute.JSON &
      Schema.Attribute.CustomField<'plugin::multi-select.multi-select', ['Login', 'Take Attendance', 'Attendance History', 'Profile']> &
      Schema.Attribute.DefaultTo<'[]'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::sus-feedback.sus-feedback'> & Schema.Attribute.Private;
    note: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiUserClassUserClass extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::user-class.user-class'> & Schema.Attribute.Private;
    note: Schema.Attribute.Text;
    position: Schema.Attribute.Enumeration<
      ['A. \u73ED\u957F', 'B. \u526F\u73ED\u957F', 'C. \u5173\u6000\u5458', 'D. \u5B66\u5458', 'E. \u65C1\u542C']
    > &
...
export interface PluginUsersPermissionsUser extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localization: Schema.Attribute.Enumeration<['English', 'Chinese', 'Malay', 'Tamil']> &
      Schema.Attribute.Required &
    ...
    notificationServices: Schema.Attribute.Relation<'oneToMany', 'api::notification-service.notification-service'>;
    password: Schema.Attribute.Password &
      Schema.Attribute.Private &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
    ...
    skill: Schema.Attribute.JSON &
      ...
      > &
      Schema.Attribute.DefaultTo<'[]'>;
    sus_feedbacks: Schema.Attribute.Relation<'oneToMany', 'api::sus-feedback.sus-feedback'> & Schema.Attribute.Private;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    userClasses: Schema.Attribute.Relation<'oneToMany', 'api::user-class.user-class'>;
    username: Schema.Attribute.String &
